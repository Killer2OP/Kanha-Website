  ...
  return (
    <div className="relative rounded-3xl overflow-hidden h-auto min-h-screen md:h-auto pt-3 p-3 sm:p-6 md:p-8 lg:p-12 backdrop-blur-xl bg-green-900/20 border border-white/10 shadow-xl">
      ...
      <p className="text-gray-200 text-base sm:text-lg leading-relaxed font-medium mb-4 sm:mb-8 text-center max-w-5xl mx-auto">
        Embark on an exhilarating jeep safari across Kanha, Bandhavgarh, and
        Pench National Parks. Each park offers unique wildlife experiences with
        expert naturalists as your guides. Morning safaris provide prime
        wildlife sightings. Book online easily, with Indian nationals advised to
        reserve 30 days ahead and foreign nationals 90 days in advance.
      </p>
...
export default SafariBookingCard;
