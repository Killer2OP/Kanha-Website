...
export const SafariBookingCard = () => {
    return (
        <div className="relative rounded-3xl overflow-hidden h-[160vh]  md:h-full pt-3 p-3 sm:p-6 md:p-8 lg:p-12 backdrop-blur-xl bg-green-900/20 border border-white/10 shadow-xl">
