...
const ContactForm = () => {
  return (
    <>
      ...
      <div
        className="relative flex flex-col md:flex-row p-10 gap-10 min-h-screen items-center bg-cover bg-center pt-20"
        style={{
          backgroundImage:
      ...
      >
        ...
        <div className="relative w-full md:w-1/2 bg-green-950/20 backdrop-blur-lg p-8 rounded-lg shadow-lg border border-white/20">
          ...
          <form className="mt-6 space-y-4">
            <input
              type="text"
              placeholder="Name"
              className="w-full p-3 border border-white/30 bg-transparent text-white rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 placeholder-gray-600"
            />
            <input
              type="email"
              placeholder="Email"
        ...
        <div className="relative w-full md:w-1/2 flex justify-center">
          {/* First Info Card */}
          <div className="absolute top-1/2 transform -translate-y-1/2 bg-green-950/20 text-white p-6 rounded-lg w-3/4 shadow-xl backdrop-blur-sm">
