...
function App() {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-4">
      ...
      <div
        className="flex-[1.5] min-h-[480px] max-h-[450px] md:max-h-[450px] lg:max-h-[790px]  
      ...
      <div className="flex-[1.5] min-h-[480px] md:max-w-2xl lg:max-w-none mx-auto w-full">
        <div className="relative min-h-[650px] md:min-h-[700px] perspective-1000">
          ...
          >
            ...
            <div className="absolute inset-0 bg-black/30 backdrop-blur-xl h-[480px] md:h-[780px] border border-white/10 rounded-xl p-3 md:p-6 overflow-y-auto md:overflow-hidden backface-hidden rotate-y-180">
