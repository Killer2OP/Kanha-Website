  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10 space-y-8">
        ...
        <div className="relative flex flex-col lg:flex-row items-center lg:items-start rounded-3xl overflow-hidden p-8 sm:p-10 lg:p-12 backdrop-blur-xl bg-green-900/20 border border-white/10 shadow-xl">
          {/* Text Content */}
