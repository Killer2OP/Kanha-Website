...
function App() {
  ...
  const hotels = [
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1499696010180-025ef6e1a8f9?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    },
  ];
        ...
        <div className="relative rounded-3xl overflow-hidden p-8 sm:p-10 lg:p-12 backdrop-blur-3xl bg-green-900/40 border border-white/10 shadow-xl">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-200 text-lg leading-relaxed font-medium">
                Crowned as one of India’s best-managed parks, Kanha is a jewel
                of <span className="text-emerald-300">Project Tiger</span>.
                Visit Bamni Dadar—Sunset Point—for breathtaking views of grazing
                Sambhars and Gaurs against a stunning sunset. With over 1,000
                flowering plant species, diverse forests of sal, bamboo, and
            ...
            <div className="relative">
              ...
              <div className="pl-6">
                <div className="flex items-center mb-4">
                  ...
                  <h4 className="text-2xl sm:text-3xl font-semibold text-white drop-shadow-md">
                    Tour Packages
                  </h4>
                </div>
                <p className="text-gray-200 text-lg leading-relaxed font-medium">
                  Discover Kanha with our affordable, customizable tour
                  packages—ranging from budget weekend escapes to luxurious
                  week-long adventures. Enjoy accommodation, safari bookings,
                  meals, and transportation, with special options for
            ...
            <div className="relative">
              ...
              <div className="pl-6">
                ...
                <p className="text-gray-200 text-lg leading-relaxed font-medium">
                  Embark on an exhilarating jeep safari across Kanha's
                  zones—Kanha, Kisli, Mukki, and Sarhi. Morning safaris offer
                  prime wildlife sightings, guided by expert naturalists. Book
                  online easily, with Indian nationals advised to reserve 30
                  days ahead and foreign nationals 90 days in advance.
                </p>
                ...
                <div className="grid sm:grid-cols-2 gap-6 mt-8">
                  <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 hover:bg-white/10 transition-all duration-300">
                    ...
                    <p className="text-gray-300 mb-3">
                      Best for wildlife activity and photography
                    </p>
                    ...
                    <div className="mt-4 pt-4 border-t border-white/10">
                      <p className="text-gray-300 text-sm">
                        ₹2,500 per person (Indian Nationals)
                      </p>
                      <p className="text-gray-300 text-sm">
                        ₹5,000 per person (Foreign Nationals)
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 hover:bg-white/10 transition-all duration-300">
                    ...
                    <p className="text-gray-300 mb-3">
                      Perfect for sunset views and predator sightings
                    </p>
                    ...
                    <div className="mt-4 pt-4 border-t border-white/10">
                      <p className="text-gray-300 text-sm">
                        ₹2,000 per person (Indian Nationals)
                      </p>
                      <p className="text-gray-300 text-sm">
                        ₹4,000 per person (Foreign Nationals)
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="relative">
              ...
              <div className="pl-6">
                ...
                <p className="text-gray-200 text-lg leading-relaxed font-medium">
                  From luxury resorts with spas to eco-friendly lodges and
                  forest rest houses, Kanha offers diverse stays. Enjoy
                  wildlife-themed décor, local cuisine, and campfire nights.
                  Book early for peak season (October-March).
                </p>
                  ...
                  {hotels.map((hotel) => (
                    ...
                    >
                      ...
                      <div className="p-4">
                        ...
                        <p className="text-emerald-300 font-semibold mt-3">
                          {hotel.price}
                        </p>
                        <Link
                          href="#"
                          className="block text-center py-2 px-4 bg-emerald-600/80 hover:bg-emerald-600 text-white rounded-lg transition-colors duration-300 mt-4"
                        >
                          View Options
                        </Link>
                      </div>
