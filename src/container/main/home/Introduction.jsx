    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="relative rounded-3xl overflow-hidden p-8 sm:p-10 lg:p-12 backdrop-blur-3xl bg-green-900/40 border border-white/10 shadow-xl">
          {/* Removed the gradient overlay inside the card to match the image */}
          ...
          {/* Content Container */}
              ...
              <div className="relative">
                ...
                <div className="relative">
                  ...
                  <div className="pl-6">
                    ...
                    <p className="text-gray-200 text-lg leading-relaxed font-medium">
                      From luxury resorts with spas to eco-friendly lodges and forest rest houses, Kanha offers diverse
                      stays. Enjoy wildlife-themed décor, local cuisine, and campfire nights. Book early for peak season
                      (October-March).
                    </p>
                    ...
                    <div className="grid md:grid-cols-3 gap-6 mt-8">
                      <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl overflow-hidden group hover:bg-white/10 transition-all duration-300">
                        <div className="relative h-48">
                          ...
                          <div className="absolute bottom-0 left-0 p-4">
                            <h5 className="text-xl font-bold text-white">Luxury Resorts</h5>
                          </div>
                        </div>
                        <div className="p-4">
                          <p className="text-gray-300 text-sm">
                            Premium comfort with pools and gourmet dining. Experience the wild in style with spacious
                            rooms and modern amenities.
                          </p>
                          <p className="text-emerald-300 font-semibold mt-3">From ₹12,000 per night</p>
                          <Link
                            href="#"
                      ...
                      <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl overflow-hidden group hover:bg-white/10 transition-all duration-300">
                        <div className="relative h-48">
                          <img
                            src="https://images.unsplash.com/photo-1521401830884-6c03c1c87ebb?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80"
                            alt="Eco Lodge"
                            className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
                          />
                          <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent"></div>
                          <div className="absolute bottom-0 left-0 p-4">
                            <h5 className="text-xl font-bold text-white">Eco-Lodges</h5>
                          </div>
                        </div>
                        <div className="p-4">
                          <p className="text-gray-300 text-sm">
                            Sustainable stays blending with nature. Environmentally friendly accommodations with
                            authentic local experiences.
                          </p>
                          <p className="text-emerald-300 font-semibold mt-3">From ₹8,000 per night</p>
                          <Link
                            href="#"
                            className="block text-center py-2 px-4 bg-emerald-600/80 hover:bg-emerald-600 text-white rounded-lg transition-colors duration-300 mt-4"
                          >
                      ...
                      <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl overflow-hidden group hover:bg-white/10 transition-all duration-300">
                        <div className="relative h-48">
                          <img
                            src="https://images.unsplash.com/photo-1499696010180-025ef6e1a8f9?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80"
                            alt="Forest Rest House"
                            className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
                          />
                          <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent"></div>
                          <div className="absolute bottom-0 left-0 p-4">
                            <h5 className="text-xl font-bold text-white">Forest Rest Houses</h5>
                          </div>
                        </div>
                        <div className="p-4">
                          <p className="text-gray-300 text-sm">
                            Authentic, close-to-nature experience. Historic accommodations within the forest for the
                            true wilderness experience.
                          </p>
                          <p className="text-emerald-300 font-semibold mt-3">From ₹5,000 per night</p>
                          <Link
                            href="#"
                            className="block text-center py-2 px-4 bg-emerald-600/80 hover:bg-emerald-600 text-white rounded-lg transition-colors duration-300 mt-4"
                          >
            ...
            {/* Optional Image Section - Uncomment and adjust path as needed */}
            {/* <div className="hidden lg:block relative">
              <img
                src="../assets/IntroTiger.png"
                alt="Majestic Bengal Tiger"
